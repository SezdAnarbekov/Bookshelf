...
import com.syezdsultanov.bookshelf.db.BookContract.BookEntry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(InformationActivity.this, startDate, mCalendar
        ...
        editFinishDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(InformationActivity.this, finishDate, mCalendar
                        .get(Calendar.YEAR), mCalendar.get(Calendar.MONTH),
                        mCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
                ...
                .input(R.string.enter_number, R.string.input_prefill, new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(MaterialDialog dialog, CharSequence input) {
                        if (input.toString().equals(""))
                            ...
                            Toast.makeText(InformationActivity.this, "Set page less than " + mPagesTextView.getText().toString(),
