package com.syezdsultanov.bookshelf.activities;
...
import com.syezdsultanov.bookshelf.db.BookContract.*;
import com.syezdsultanov.bookshelf.utilities.UtilsBitmap;
import com.syezdsultanov.bookshelf.utilities.UtilsReadPermission;
...
public class RewriterActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            if (extras.getBoolean("isInGoogleBooks")) {
                Glide.with(RewriterActivity.this).
                        load(imageExtra).
                        asBitmap().
                        into(mImageView);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mBookHasChanged) {
                    NavUtils.navigateUpFromSameTask(RewriterActivity.this);
                    return true;
                }
    ...
    private void setCoverChange() {
        new MaterialDialog.Builder(RewriterActivity.this)
                ...
                .itemsCallback(new MaterialDialog.ListCallback() {
                    ...
                    public void onSelection(MaterialDialog dialog, View itemView, int position, CharSequence text) {
                        if (position == 0) {
                            if (ContextCompat.checkSelfPermission(RewriterActivity.this, Manifest.permission.CAMERA)
                                    != PackageManager.PERMISSION_GRANTED) {
                                ActivityCompat.requestPermissions(RewriterActivity.this,
    ...
    private void cameraIntent() {
        ...
        if (intent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(RewriterActivity.this, getString(R.string.cover_change_no_camera_app)
