...
public class BookCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        RatingBar ratingBar = view.findViewById(R.id.book_rating);

        TextView startTextView = view.findViewById(R.id.catalog_start_date);
        TextView finishTextView = view.findViewById(R.id.catalog_finish_date);
        TextView percentTextView = view.findViewById(R.id.catalog_percent);
        TextView ratioTextView = view.findViewById(R.id.catalog_pages_ratio);
        ProgressBar progressBar = view.findViewById(R.id.catalog_progress_bar);
